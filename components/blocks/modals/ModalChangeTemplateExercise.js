...
import { handleUpdateExercise, removeExercise } from '../../../datastore/useActivityTemplateStore'
import ExerciseTemplateTextField from '../inputs/ExerciseTemplateTextField'
import { AxiosContext } from '../../../datastore/AxiosContext'

const ModalChangeTemplateExercise = ({exercise, indices, modalVisible, setModalVisible, navigation}) => {
    const [ exerciseData, setExerciseData ] = useState(exercise)
    const axiosContext = useContext(AxiosContext)

    const handleSubmit = () => {
        handleUpdateExercise(axiosContext, indices.activityIndex, indices.exerciseIndex, exerciseData, navigation)
    ...
    const handleChange = (activityIndex, exerciseIndex, name, value) => {
...
export default ModalChangeTemplateExercise;