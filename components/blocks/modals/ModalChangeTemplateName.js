...
import { handleChangeActivityName } from '../../../datastore/useActivityTemplateStore'
import { AxiosContext } from '../../../datastore/AxiosContext'

const ModalChangeTemplateName = ({activityName, indices, modalVisible, setModalVisible, navigation}) => {
    const [ activity, setActivity ] = useState(activityName)
    const axiosContext = useContext(AxiosContext)

    const handleSubmit = () => {
        handleChangeActivityName(axiosContext, indices.activityIndex, activity, navigation)
...
export default ModalChangeTemplateName;